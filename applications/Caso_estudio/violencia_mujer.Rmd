...
Dentro del proceso de tokenización se a procedido a dividir un texto en las unidades que los conforman, para el caso de estudio se ha procedido a dividir por n-gramas con un **n = 2**. 
